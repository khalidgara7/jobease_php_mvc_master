            ...
            <div class="h-100">
                ...
                <ul class="sidebar_nav">
                    <li class="sidebar_item active" style="width: 100%;">
                        <a href="?route=dashboard_admin" class="sidebar_link"> <img src="/assets/img/1. overview.svg" alt="icon">Overview</a>
                    </li>
                ...
                <table class="agent table align-middle bg-white" style="min-width: 700px;">
                    ...
                    ?>
                        <tr class="freelancer">
                            ...
                            <td class="">
                                <a href=""><img class="accept_task w-50" src="/assets/img/journal-check.svg" alt="icon" ></a>
                                <a href="?route=deleteOffre&dleteid=<?= $offer['OffreID']?>"><img class="delet_user w-50" src="/assets/img/journal-x.svg" alt="icon"></a>
                            </td>
                        </tr>
                    <?php
                    }
